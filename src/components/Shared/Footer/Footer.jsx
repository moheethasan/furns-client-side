...
const Footer = () => {
  return (
    <>
      <footer className="bg-slate-300 mt-16 md:mt-24 py-20 px-4 relative">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 text-black z-20 relative">
          <div className="col-span-1">
            ...
            <p className="mt-4">
              Discover premium furniture that combines style and functionality
              at Furns. Explore limitless possibilities and elevate your
              home&#39;s elegance.
            </p>
          </div>
          <div className="col-span-1">
            <h3 className="text-xl font-bold mb-5">Helpful Links</h3>
            <p className="mb-4 hover:text-orange-600 w-fit">
      ...
      <p className="text-center text-white bg-slate-600 py-4">
        <small>
